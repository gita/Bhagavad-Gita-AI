  ...
  return (
    <>
      <Head>
        ...
        <meta name="keywords" content="Bhagavad Gita AI, ChatGPT, GPT, Krishna" />
        <meta name="robots" content="index,follow" />
        <meta name="author" content="Ved Vyas Foundation" />

        <meta property="og:title" content="Bhagavad Gita AI: Unlock the Wisdom of Krishna with GitaGPT" />
